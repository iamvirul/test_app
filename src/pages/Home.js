    ...
    <div className="col-12">
      <div className="row">
        <div className=" col-12 d-flex">
            ...
            <div className="col-lg-6 text-end d-flex align-items-center justify-content-end">
            <Link to={"More"}>
              <List size={40} color={"royalblue"} className=" menu" />
            </Link>
          </div>
      ...
      <div className=" col-12 rowdev">
        ...
        <div className=" col-11">
          <div className=" d-flex col-12 justify-content-end">
            <span>All right reserved 2023 ® | develope by virul.n</span>
          </div>
        </div>
      </div>
    </div>
